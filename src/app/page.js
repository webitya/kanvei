        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Premium quality products carefully selected for you</p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Competitive pricing with amazing deals and offers</p>
            </div>
            <div className="text-center p-6">
